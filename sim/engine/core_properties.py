"""The outside-facing property surface for the authoritative SimulationState.
...
of pushing every other reader of core.py past all of them to reach anything else.

In the live state architecture, these properties delegate directly to
the authoritative live SimulationState and child subsystem objects:
...
class ForwardingPropertiesMixin:
	"""Composition point: every property below delegates directly to self.state
	subsystem objects, providing seamless compatibility while backing all storage
	in authoritative typed state.
	"""
	...
	def _material_stock_ledger(self):
		sub = getattr(self.state, "economy", None)
		if sub is None:
			raise AttributeError("_material_stock_ledger")
		val = getattr(sub, "_material_stock_ledger", None)
		if val is None:
			raise AttributeError("_material_stock_ledger")
		return val
	...
	def _material_stock_ledger(self, value):
		sub = getattr(self.state, "economy", None)
		if sub is not None:
			setattr(sub, "_material_stock_ledger", value)

	@property
	def _said_autoopen(self):
		sub = getattr(self.state, "household", None)
		if sub is None:
			raise AttributeError("_said_autoopen")
		val = getattr(sub, "_said_autoopen", None)
		if val is None:
			raise AttributeError("_said_autoopen")
		return val
	...
	def _said_autoopen(self, value):
		sub = getattr(self.state, "household", None)
		if sub is not None:
			setattr(sub, "_said_autoopen", value)
	...
	@property
	def _said_debasement(self):
		sub = getattr(self.state, "scenario", None)
		if sub is None:
			raise AttributeError("_said_debasement")
		val = getattr(sub, "_said_debasement", None)
		if val is None:
			raise AttributeError("_said_debasement")
		return val

	@_said_debasement.setter
	def _said_debasement(self, value):
		sub = getattr(self.state, "scenario", None)
		if sub is not None:
			setattr(sub, "_said_debasement", value)

	@property
	def _said_deputies(self):
		sub = getattr(self.state, "household", None)
		if sub is None:
			raise AttributeError("_said_deputies")
		val = getattr(sub, "_said_deputies", None)
		if val is None:
			raise AttributeError("_said_deputies")
		return val
	...
	def _said_deputies(self, value):
		sub = getattr(self.state, "household", None)
		if sub is not None:
			setattr(sub, "_said_deputies", value)

	@property
	def _said_near_limit(self):
		sub = getattr(self.state, "household", None)
		if sub is None:
			raise AttributeError("_said_near_limit")
		val = getattr(sub, "_said_near_limit", None)
		if val is None:
			raise AttributeError("_said_near_limit")
		return val
	...
	def _said_near_limit(self, value):
		sub = getattr(self.state, "household", None)
		if sub is not None:
			setattr(sub, "_said_near_limit", value)

	@property
	def _said_output(self):
		sub = getattr(self.state, "scenario", None)
		if sub is None:
			raise AttributeError("_said_output")
		val = getattr(sub, "_said_output", None)
		if val is None:
			raise AttributeError("_said_output")
		return val

	@_said_output.setter
	def _said_output(self, value):
		sub = getattr(self.state, "scenario", None)
		if sub is not None:
			setattr(sub, "_said_output", value)
	...
	@property
	def atrocity(self):
		return getattr(self.state.household, "atrocity")

	@atrocity.setter
	def atrocity(self, value):
		setattr(self.state.household, "atrocity", value)
	...
	@property
	def bribes_ytd(self):
		return getattr(self.state.household, "bribes_ytd")

	@bribes_ytd.setter
	def bribes_ytd(self, value):
		setattr(self.state.household, "bribes_ytd", value)
	...
	def commissioned(self):
		return getattr(self.state.household, "commissioned")

	@commissioned.setter
	def commissioned(self, value):
		setattr(self.state.household, "commissioned", value)
	...
	@property
	def director_hours_spent_founder(self):
		return getattr(self.state.founder, "director_hours_spent_founder")

	@director_hours_spent_founder.setter
	def director_hours_spent_founder(self, value):
		setattr(self.state.founder, "director_hours_spent_founder", value)
	...
	@property
	def gov(self):
		return getattr(self.state.governance, "gov")

	@gov.setter
	def gov(self, value):
		setattr(self.state.governance, "gov", value)
	...
	def granted_staff(self):
		sub = getattr(self.state, "household", None)
		if sub is None:
			raise AttributeError("granted_staff")
		val = getattr(sub, "granted_staff", None)
		if val is None:
			raise AttributeError("granted_staff")
		return val
	...
	def granted_staff(self, value):
		sub = getattr(self.state, "household", None)
		if sub is not None:
			setattr(sub, "granted_staff", value)
	...
	@property
	def last_patron_death(self):
		sub = getattr(self.state, "founder", None)
		if sub is None:
			raise AttributeError("last_patron_death")
		val = getattr(sub, "last_patron_death", None)
		if val is None:
			raise AttributeError("last_patron_death")
		return val

	@last_patron_death.setter
	def last_patron_death(self, value):
		sub = getattr(self.state, "founder", None)
		if sub is not None:
			setattr(sub, "last_patron_death", value)
	...
	def last_withdrawal(self):
		sub = getattr(self.state, "household", None)
		if sub is None:
			raise AttributeError("last_withdrawal")
		val = getattr(sub, "last_withdrawal", None)
		if val is None:
			raise AttributeError("last_withdrawal")
		return val
	...
	def last_withdrawal(self, value):
		sub = getattr(self.state, "household", None)
		if sub is not None:
			setattr(sub, "last_withdrawal", value)
	...
	@property
	def living_cost_paid(self):
		return getattr(self.state.founder, "living_cost_paid")

	@living_cost_paid.setter
	def living_cost_paid(self, value):
		setattr(self.state.founder, "living_cost_paid", value)
	...
	def market_pressure(self):
		return getattr(self.state.economy, "market_pressure")

	@market_pressure.setter
	def market_pressure(self, value):
		setattr(self.state.economy, "market_pressure", value)

	@property
	def mine_cost_paid(self):
		return getattr(self.state.economy, "mine_cost_paid")

	@mine_cost_paid.setter
	def mine_cost_paid(self, value):
		setattr(self.state.economy, "mine_cost_paid", value)

	@property
	def mine_pending(self):
		return getattr(self.state.economy, "mine_pending")

	@mine_pending.setter
	def mine_pending(self, value):
		setattr(self.state.economy, "mine_pending", value)

	@property
	def mine_ready(self):
		return getattr(self.state.economy, "mine_ready")

	@mine_ready.setter
	def mine_ready(self, value):
		setattr(self.state.economy, "mine_ready", value)
	...
	def opened_year(self):
		return getattr(self.state.projects, "opened_year")

	@opened_year.setter
	def opened_year(self, value):
		setattr(self.state.projects, "opened_year", value)
	...
	@property
	def stalled(self):
		return getattr(self.state.projects, "stalled")

	@stalled.setter
	def stalled(self, value):
		setattr(self.state.projects, "stalled", value)
	...
	def total_spend(self):
		return getattr(self.state.household, "total_spend")

	@total_spend.setter
	def total_spend(self, value):
		setattr(self.state.household, "total_spend", value)
	...
	@property
	def wages_paid(self):
		return getattr(self.state.household, "wages_paid")

	@wages_paid.setter
	def wages_paid(self, value):
		setattr(self.state.household, "wages_paid", value)
